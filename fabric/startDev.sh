...
docker network create SSISH-TCC-matheusLazaro-chaincode-net
./network.sh up createChannel -n $ORG_QNTY
./network.sh deployCC -ccn SSISH-TCC-matheusLazaro-chaincode -ccp ../chaincode -ccl go -n $ORG_QNTY -cccg $CCCG_PATH